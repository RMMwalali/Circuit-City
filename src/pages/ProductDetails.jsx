          ...
          <Row>
            ...
            <Col lg="6">
              <div className="product_details">
                ...
                <motion.button whileTap={{ scale: 1.2}} onClick={addToCart} className='buy_button'>Add to Cart</motion.button>
              </div>
            </Col>
          </Row>
        </Container>
                    ...
                    <div className='product_review mt-5'>
                      ...
                      <div className="review_form">
                        ...
                        <form action="" onSubmit={submitHandler}>
                          ...
                          <motion.button whileTap={{ scale: 1.2 }} type="submit" className="buy_button">
                            Submit
                          </motion.button>
                          </form>
                      </div>
